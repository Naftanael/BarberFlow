    ...
    <div className="min-h-screen w-full bg-background flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md mx-auto shadow-2xl border-2 border-primary/20">
        <CardHeader className="text-center space-y-4">
          ...
          <CardTitle className="font-headline text-3xl tracking-wider">
            Bem-vindo de volta
          </CardTitle>
        ...
        <CardContent>
          <form className="space-y-6">
            <div className="space-y-2">
              <Label
                htmlFor="email"
                className="font-headline tracking-wide text-base"
              >
                Email
              </Label>
              <Input
            ...
            <Link href="/dashboard" passHref>
              <Button
                type="submit"
                size="lg"
                className="w-full font-headline text-xl tracking-wider mt-4"
              >
                Entrar
              </Button>
            </Link>
