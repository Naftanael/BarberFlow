...
export default function Chatbot() {
  ...
  const [messages, setMessages] = useState([
    {
      from: 'bot',
      text: 'Olá! Sou seu assistente BarberFlow. Para começar, qual é o seu nome?',
    },
  ]);
    ...
    setTimeout(() => {
      ...
      if (isClosed) {
        setMessages((prev) => [
          ...
          {
            from: 'bot',
            text: 'No momento, a barbearia está fechada. Nosso horário de funcionamento é de segunda a sábado, das 9h às 18h. Por favor, entre em contato durante esse período.',
          },
        ]);
        return;
      }
      ...
      if (chatState === CHAT_STATE.AWAITING_NAME) {
        ...
        setMessages((prev) => [
          ...
          {
            from: 'bot',
            text: `Obrigado, ${text}! Agora, por favor, me informe seu telefone.`,
          },
        ]);
        ...
        setMessages((prev) => [
          ...
          {
            from: 'bot',
            text: `Perfeito, ${userName}! Para qual dia e horário você gostaria de agendar?`,
          },
        ]);
        ...
        setMessages((prev) => [
          ...
          {
            from: 'bot',
            text: 'Ok! Estou verificando a disponibilidade... Um momento.',
          },
        ]);
      }
    }, 1000);
    ...
    <Card className="fixed bottom-4 right-4 w-80 h-[28rem] flex flex-col shadow-lg z-50 animate-in fade-in-50 slide-in-from-bottom-10 duration-500">
      <CardHeader className="flex flex-row items-center justify-between p-4 border-b">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <p className="text-sm font-medium leading-none font-headline tracking-wide">
              Assistente
            </p>
